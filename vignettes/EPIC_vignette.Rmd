...
Please note that we generated and pre-stored gene annotations `annotation_dictionary.txt` using the default setting in the package. To obtain the path (`epic_path_to_ad`) to `annotation_dictionary.txt`, please use R command `system.file("extdata", "annotation_dictionary.txt", package = "EPIC")`. 
...
# Specify epic_path_to_ad using the output returned from R command
epic_path_to_ad=/path/to/epic/annotation_dictionary.txt

cp $epic_path_to_ad $out_dir/annotation_dictionary.txt
